[![Automatic version updates](https://github.com/zopencommunity/m4port/actions/workflows/bump.yml/badge.svg)](https://github.com/zopencommunity/m4port/actions/workflows/bump.yml)
...
For details on the build, see (https://zopen.community/Guides/Porting)
